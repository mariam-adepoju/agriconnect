    ...
    <main className="bg-grany min-h-screen py-20 px-4 md:px-16 lg:px-24 xl:px-32">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7">
          <Card className="p-8 rounded-xl shadow-sm">
            <div className="w-40 overflow-hidden mb-8">
        ...
        <div className="lg:col-span-5 space-y-5">
          <Card className="p-5 text-[#404040] rounded-xl shadow-sm">
      ...
      <PaymentSuccessModal
        ...
        onClose={() => {
          ...
          navigate("/"); // Could redirect to orders page
        }}
      />
